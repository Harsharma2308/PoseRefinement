...
parser.add_argument('--refine_model', type=str, default = ' trained_models/linemod/pose_refine_model_98_0.0064081341689759255.pth',  help='resume PoseRefineNet model')
...
fw = open('{0}/eval_result_logsNoRefine.txt'.format(output_result_dir), 'w')
